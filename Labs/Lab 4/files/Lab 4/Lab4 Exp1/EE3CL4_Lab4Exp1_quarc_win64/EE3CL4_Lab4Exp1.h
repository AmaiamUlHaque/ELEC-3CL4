...
#ifndef RTW_HEADER_EE3CL4_Lab4Exp1_h_
#define RTW_HEADER_EE3CL4_Lab4Exp1_h_
#ifndef EE3CL4_Lab4Exp1_COMMON_INCLUDES_
#define EE3CL4_Lab4Exp1_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* EE3CL4_Lab4Exp1_COMMON_INCLUDES_ */

#include "EE3CL4_Lab4Exp1_types.h"
...
#define EE3CL4_Lab4Exp1_rtModel        RT_MODEL_EE3CL4_Lab4Exp1_T

/* Block signals (default storage) */
typedef struct {
  real_T desiredpos;                   /* '<Root>/desired pos' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } actualpos_PWORK;                   /* '<Root>/actual pos' */
  ...
  int32_T clockTickCounter;            /* '<Root>/desired pos' */
  int32_T HILReadEncoder_Buffer;       /* '<Root>/HIL Read Encoder' */
} DW_EE3CL4_Lab4Exp1_T;
...
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
} XDot_EE3CL4_Lab4Exp1_T;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
} XDis_EE3CL4_Lab4Exp1_T;
...
#define rtB                            EE3CL4_Lab4Exp1_B
#define BlockIO                        B_EE3CL4_Lab4Exp1_T
#define rtX                            EE3CL4_Lab4Exp1_X
#define ContinuousStates               X_EE3CL4_Lab4Exp1_T
#define rtXdot                         EE3CL4_Lab4Exp1_XDot
#define StateDerivatives               XDot_EE3CL4_Lab4Exp1_T
#define tXdis                          EE3CL4_Lab4Exp1_XDis
#define StateDisabled                  XDis_EE3CL4_Lab4Exp1_T
#define rtP                            EE3CL4_Lab4Exp1_P
#define Parameters                     P_EE3CL4_Lab4Exp1_T
#define rtDWork                        EE3CL4_Lab4Exp1_DW
#define D_Work                         DW_EE3CL4_Lab4Exp1_T

/* Parameters (default storage) */
struct P_EE3CL4_Lab4Exp1_T_ {
  ...
  real_T HILInitialize_OOWatchdog[3];  /* Expression: watchdog_other_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T desiredpos_Amp;               /* Expression: 1.5
                                        * Referenced by: '<Root>/desired pos'
                                        */
  real_T desiredpos_Period;            /* Computed Parameter: desiredpos_Period
                                        * Referenced by: '<Root>/desired pos'
                                        */
  real_T desiredpos_Duty;              /* Computed Parameter: desiredpos_Duty
                                        * Referenced by: '<Root>/desired pos'
                                        */
  real_T desiredpos_PhaseDelay;        /* Expression: 0
                                        * Referenced by: '<Root>/desired pos'
                                        */
  real_T Gain_Gain;                    /* Expression: 2*pi/2048
...
struct tag_RTM_EE3CL4_Lab4Exp1_T {
  const char_T *path;
...
extern P_EE3CL4_Lab4Exp1_T EE3CL4_Lab4Exp1_P;

/* Block signals (default storage) */
extern B_EE3CL4_Lab4Exp1_T EE3CL4_Lab4Exp1_B;

/* Continuous states (default storage) */
extern X_EE3CL4_Lab4Exp1_T EE3CL4_Lab4Exp1_X;

/* Disabled states (default storage) */
extern XDis_EE3CL4_Lab4Exp1_T EE3CL4_Lab4Exp1_XDis;

/* Block states (default storage) */
extern DW_EE3CL4_Lab4Exp1_T EE3CL4_Lab4Exp1_DW;

/* Model entry point functions */
extern void EE3CL4_Lab4Exp1_initialize(void);
extern void EE3CL4_Lab4Exp1_output(void);
extern void EE3CL4_Lab4Exp1_update(void);
extern void EE3CL4_Lab4Exp1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern EE3CL4_Lab4Exp1_rtModel *EE3CL4_Lab4Exp1(void);
...
extern RT_MODEL_EE3CL4_Lab4Exp1_T *const EE3CL4_Lab4Exp1_M;
 ...
 *
 * '<Root>' : 'EE3CL4_Lab4Exp1'
 */
#endif                                 /* RTW_HEADER_EE3CL4_Lab4Exp1_h_ */
