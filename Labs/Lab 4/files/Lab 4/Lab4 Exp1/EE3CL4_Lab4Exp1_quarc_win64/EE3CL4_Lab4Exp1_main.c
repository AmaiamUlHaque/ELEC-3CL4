...
typedef RT_MODEL_EE3CL4_Lab4Exp1_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * EE3CL4_Lab4Exp1(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(EE3CL4_Lab4Exp1_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: EE3CL4_Lab4Exp1 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
