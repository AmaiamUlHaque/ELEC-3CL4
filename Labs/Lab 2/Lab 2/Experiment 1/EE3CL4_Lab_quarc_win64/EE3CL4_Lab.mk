###########################################################################
## Makefile generated for component 'EE3CL4_Lab'. 
## 
## Makefile     : EE3CL4_Lab.mk
## Generated on : Thu Feb 12 15:37:06 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\EE3CL4_Lab.rt-win64
...
PRODUCT_NAME              = EE3CL4_Lab
MAKEFILE                  = EE3CL4_Lab.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2023b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2023b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\haquea24\Desktop\3CL4LA~1\LAB2~1\EXPERI~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = EE3CL4_Lab_comp.rsp
CMD_FILE                  = EE3CL4_Lab.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\EE3CL4_Lab.rt-win64
...
DEFINES_STANDARD = -DMODEL=EE3CL4_Lab -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\EE3CL4_Lab_quarc_win64\EE3CL4_Lab.c $(START_DIR)\EE3CL4_Lab_quarc_win64\EE3CL4_Lab_data.c $(START_DIR)\EE3CL4_Lab_quarc_win64\EE3CL4_Lab_main.c $(START_DIR)\EE3CL4_Lab_quarc_win64\rtGetInf.c $(START_DIR)\EE3CL4_Lab_quarc_win64\rtGetNaN.c $(START_DIR)\EE3CL4_Lab_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = EE3CL4_Lab.obj EE3CL4_Lab_data.obj EE3CL4_Lab_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\EE3CL4_Lab_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\EE3CL4_Lab_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
EE3CL4_Lab.obj : "$(START_DIR)\EE3CL4_Lab_quarc_win64\EE3CL4_Lab.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab_quarc_win64\EE3CL4_Lab.c"


EE3CL4_Lab_data.obj : "$(START_DIR)\EE3CL4_Lab_quarc_win64\EE3CL4_Lab_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab_quarc_win64\EE3CL4_Lab_data.c"


EE3CL4_Lab_main.obj : "$(START_DIR)\EE3CL4_Lab_quarc_win64\EE3CL4_Lab_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab_quarc_win64\EE3CL4_Lab_main.c"


rtGetInf.obj : "$(START_DIR)\EE3CL4_Lab_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\EE3CL4_Lab_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\EE3CL4_Lab_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab_quarc_win64\rt_nonfinite.c"
