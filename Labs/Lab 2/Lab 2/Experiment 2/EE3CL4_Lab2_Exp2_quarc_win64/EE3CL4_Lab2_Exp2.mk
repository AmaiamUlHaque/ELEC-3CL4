###########################################################################
## Makefile generated for component 'EE3CL4_Lab2_Exp2'. 
## 
## Makefile     : EE3CL4_Lab2_Exp2.mk
## Generated on : Thu Feb 12 15:34:35 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\EE3CL4_Lab2_Exp2.rt-win64
...
PRODUCT_NAME              = EE3CL4_Lab2_Exp2
MAKEFILE                  = EE3CL4_Lab2_Exp2.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2023b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2023b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = C:\Users\haquea24\Desktop\3CL4LA~1\LAB2~1\EXPERI~2
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = EE3CL4_Lab2_Exp2_comp.rsp
CMD_FILE                  = EE3CL4_Lab2_Exp2.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\EE3CL4_Lab2_Exp2.rt-win64
...
DEFINES_STANDARD = -DMODEL=EE3CL4_Lab2_Exp2 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\EE3CL4_Lab2_Exp2.c $(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\EE3CL4_Lab2_Exp2_data.c $(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\EE3CL4_Lab2_Exp2_main.c $(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\rtGetInf.c $(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\rtGetNaN.c $(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = EE3CL4_Lab2_Exp2.obj EE3CL4_Lab2_Exp2_data.obj EE3CL4_Lab2_Exp2_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
EE3CL4_Lab2_Exp2.obj : "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\EE3CL4_Lab2_Exp2.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\EE3CL4_Lab2_Exp2.c"


EE3CL4_Lab2_Exp2_data.obj : "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\EE3CL4_Lab2_Exp2_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\EE3CL4_Lab2_Exp2_data.c"


EE3CL4_Lab2_Exp2_main.obj : "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\EE3CL4_Lab2_Exp2_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\EE3CL4_Lab2_Exp2_main.c"


rtGetInf.obj : "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab2_Exp2_quarc_win64\rt_nonfinite.c"
