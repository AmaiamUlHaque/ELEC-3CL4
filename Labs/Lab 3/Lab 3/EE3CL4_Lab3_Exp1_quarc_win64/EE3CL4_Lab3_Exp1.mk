###########################################################################
## Makefile generated for component 'EE3CL4_Lab3_Exp1'. 
## 
## Makefile     : EE3CL4_Lab3_Exp1.mk
## Generated on : Thu Mar 05 16:16:08 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\EE3CL4_Lab3_Exp1.rt-win64
...
COMPILER_COMMAND_FILE     = EE3CL4_Lab3_Exp1_comp.rsp
CMD_FILE                  = EE3CL4_Lab3_Exp1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\EE3CL4_Lab3_Exp1.rt-win64
...
DEFINES_STANDARD = -DMODEL=EE3CL4_Lab3_Exp1 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\EE3CL4_Lab3_Exp1.c $(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\EE3CL4_Lab3_Exp1_data.c $(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\EE3CL4_Lab3_Exp1_main.c $(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\rtGetInf.c $(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\rtGetNaN.c $(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = EE3CL4_Lab3_Exp1.obj EE3CL4_Lab3_Exp1_data.obj EE3CL4_Lab3_Exp1_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
EE3CL4_Lab3_Exp1.obj : "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\EE3CL4_Lab3_Exp1.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\EE3CL4_Lab3_Exp1.c"


EE3CL4_Lab3_Exp1_data.obj : "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\EE3CL4_Lab3_Exp1_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\EE3CL4_Lab3_Exp1_data.c"


EE3CL4_Lab3_Exp1_main.obj : "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\EE3CL4_Lab3_Exp1_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\EE3CL4_Lab3_Exp1_main.c"


rtGetInf.obj : "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp1_quarc_win64\rt_nonfinite.c"
