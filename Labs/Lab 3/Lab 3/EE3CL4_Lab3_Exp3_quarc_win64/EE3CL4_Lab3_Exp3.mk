###########################################################################
## Makefile generated for component 'EE3CL4_Lab3_Exp3'. 
## 
## Makefile     : EE3CL4_Lab3_Exp3.mk
## Generated on : Thu Mar 05 17:03:54 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\EE3CL4_Lab3_Exp3.rt-win64
...
COMPILER_COMMAND_FILE     = EE3CL4_Lab3_Exp3_comp.rsp
CMD_FILE                  = EE3CL4_Lab3_Exp3.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\EE3CL4_Lab3_Exp3.rt-win64
...
DEFINES_STANDARD = -DMODEL=EE3CL4_Lab3_Exp3 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\EE3CL4_Lab3_Exp3.c $(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\EE3CL4_Lab3_Exp3_data.c $(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\EE3CL4_Lab3_Exp3_main.c $(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\rtGetInf.c $(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\rtGetNaN.c $(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = EE3CL4_Lab3_Exp3.obj EE3CL4_Lab3_Exp3_data.obj EE3CL4_Lab3_Exp3_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
EE3CL4_Lab3_Exp3.obj : "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\EE3CL4_Lab3_Exp3.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\EE3CL4_Lab3_Exp3.c"


EE3CL4_Lab3_Exp3_data.obj : "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\EE3CL4_Lab3_Exp3_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\EE3CL4_Lab3_Exp3_data.c"


EE3CL4_Lab3_Exp3_main.obj : "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\EE3CL4_Lab3_Exp3_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\EE3CL4_Lab3_Exp3_main.c"


rtGetInf.obj : "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\EE3CL4_Lab3_Exp3_quarc_win64\rt_nonfinite.c"
